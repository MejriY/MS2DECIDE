...
**Ensure Python is installed**  
   Before proceeding, make sure Python (version 3.8 or higher) is installed on your system. Make sure to type y (or press Enter) to proceed with the installationAlternatively, you can use **Conda**, which includes Python. Download and install Conda from https://docs.conda.io/projects/conda/en/stable/.
...
[source,console]
----
conda create --name ms2decide_env python=3.8
----
